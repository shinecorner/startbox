                        ...
                        <div class="row">
                            <div class="col-12 pt-2 pb-2 border-bottom-blue-grey border-bottom-lighten-5">
                                <div class="info-time-tracking-title d-flex justify-content-between align-items-center">
                                    <h4 class="pl-2 mb-0 title-info-time-heading text-bold-500">Procedures
                                    </h4>
                                    <span class="pr-2">
                                ...
                                <tbody>
                                        ...
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="/admin/app-assets/images/portrait/small/avatar-s-11.png"
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="/admin/app-assets/images/portrait/small/avatar-s-14.png"
                                                    alt="Generic placeholder image">
                                            </div>
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="/admin/app-assets/images/portrait/small/avatar-s-15.png"
                                                    alt="Generic placeholder image">
                                            </div>
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="/admin/app-assets/images/portrait/small/avatar-s-4.png"
                                                    alt="Generic placeholder image">
                                            </div>
                                    ...
                                    <tr>
                                        <td class="text-truncate">
                                            <div class="avatar avatar-md mr-1">
                                                <img class="rounded-circle"
                                                    src="/admin/app-assets/images/portrait/small/avatar-s-19.png"
                                                    alt="Generic placeholder image">
                                            </div>
                                        ...
                                        <div>
                                            <ul
                                                ...
                                                <li class="avatar avatar-sm pull-up my-0">
                                                    <img class="rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-20.png"
                                    ...
                                    <li class="timeline-items timeline-icon-info">
                                        ...
                                        <div>
                                            <ul
                                                ...
                                                <li class="avatar avatar-sm pull-up my-0">
                                                    <img class="rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-21.png"
                                                        alt="Generic placeholder image" data-toggle="tooltip"
                                                        data-placement="top" title="Stepan">
                                                </li>
                                                <li class="avatar avatar-sm pull-up my-0">
                                                    <img class="rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-22.png"
                                                        alt="Generic placeholder image" data-toggle="tooltip"
...
<script>
    ...
    export default {
        mixins: [DashboardServices, AuthServices],
        props: ["app_name"],
        data() {
            return {};
        },
