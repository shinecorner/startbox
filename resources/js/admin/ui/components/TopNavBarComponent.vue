    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                    ...
                    <div class="avatar avatar-online"><img src="/admin/app-assets/images/portrait/small/avatar-s-1.png"
                            alt="avatar"><i></i>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div><a @click="logOut" class="dropdown-item"><i
