@extends('admin.layouts.email.template') 
...
<div style="color: #444444">
        ...
        <p>You are receiving this email because we received a password reset request for your account. Click below to reset your password.</p>
